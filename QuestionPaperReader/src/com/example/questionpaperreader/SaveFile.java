			...
			public void onItemClick(AdapterView<?> paret, View viewClicked, int position, long id) {
				...
				if(f.isDirectory()){
					try{
						...
						Toast.makeText(SaveFile.this, "Cannot open directory!", Toast.LENGTH_SHORT).show();
					}
				}
				else{
					Toast.makeText(SaveFile.this, "Exception....Opened a file!", Toast.LENGTH_SHORT).show();
				}
			}		
		});
